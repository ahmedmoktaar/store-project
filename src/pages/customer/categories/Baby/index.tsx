...
const BabyCategoriesPage = () => {
  ...
  const lowerCaseCategoriesByGender = categoriesByGender("Baby").map(
  ...
  // --------------------------------------------------
  const filteredCategories = UniqueCategoriesArray("baby", "Baby");

  return (
    <Holder>
      <SideNavCategories storeCategory="baby" />
